              ...
              <Card className="card-custom p-4">
                <Card.Body>
                  ...
                  <p className="fs-5 mb-4">
                    A <strong>JB Studio Developer</strong> não é apenas uma empresa - é o meu 
                  ...
                  <p className="fs-5 mb-4">
                    Funciona como um <strong>portfólio vivo</strong>, onde cada ideia ganha 
                  ...
                  <p className="fs-5 mb-4">
                    Cada projeto que desenvolvo aqui terá sua própria <strong>landing page</strong> 
                  ...
                  <p className="fs-5">
                    O objetivo é manter um visual <strong>limpo e institucional</strong>, 
                ...
                <Col md={4} className="mb-4">
                  <Card className="card-custom h-100 text-center p-3">
                    <Card.Body>
                      ...
                      <p>
                        Processo aberto, roadmaps claros e comunicação 
                        honesta sobre cada etapa dos projetos.
                      </p>
                    </Card.Body>
                  </Card>
                </Col>
