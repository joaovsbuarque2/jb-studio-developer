  ...
  const features = [
    {
      ...
      description:
        'Transforme suas tarefas em missões épicas. Ganhe XP, suba de nível e desbloqueie conquistas.',
    },
    {
      icon: '🏆',
      title: 'Torneios e Desafios',
      description:
        'Compete com amigos em desafios de produtividade e participe de torneios semanais.',
    },
    {
      icon: '📊',
      title: 'Analytics Detalhado',
      description:
        'Acompanhe seu progresso com relatórios visuais e insights sobre sua produtividade.',
    },
    {
      icon: '👥',
      title: 'Social e Colaborativo',
      description:
        'Conecte-se com outros usuários, forme equipes e alcance objetivos juntos.',
    },
  ];
            ...
            <Col lg={8}>
              <div className="hero-content">
                ...
                <p className="fs-5 mb-4">
                  O app mobile gamificado que transforma suas tarefas diárias em
                  missões épicas. Ganhe XP, participe de torneios e transforme
          ...
          <Row>
            <Col lg={8} className="mx-auto text-center">
              ...
              <p className="section-subtitle">
                Aplicativos de produtividade tradicionais são chatos e
                desmotivantes
              </p>
            </Col>
          </Row>
              ...
              <Card className="card-custom p-4 h-100">
                <Card.Body>
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-2">
                      ❌ Interfaces monótonas e repetitivas
                    </li>
                    <li className="mb-2">
                      ❌ Falta de motivação para continuar
                    </li>
                    <li className="mb-2">
                      ❌ Nenhum elemento social ou competitivo
                    </li>
            ...
            <Col lg={6} className="mb-4">
              <Card className="card-custom p-4 h-100">
                <Card.Body>
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-2">
                      ✅ Gamificação envolvente e divertida
                    </li>
                    <li className="mb-2">
                    ...
                    <li className="mb-2">
                      ✅ Comunidade engajada e apoio mútuo
                    </li>
                  </ul>
                </Card.Body>
              </Card>
              ...
              <Card className="card-custom p-5">
                <Card.Body>
                  ...
                  <p className="section-subtitle mb-4">
                    Entre em contato para receber updates sobre o Eleva e ser um
                    dos primeiros a testar quando estiver pronto!
                  </p>
                  <Button
                    as={Link}
                    to="/contato"
