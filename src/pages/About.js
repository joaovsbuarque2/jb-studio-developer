...
function About() {
  const stacks = [
    ...
    'Next.js', 'Bootstrap', 'Figma', 'Git', 'JavaScript'
  ];
              ...
              <Card className="card-custom p-4 mb-4">
                <Card.Body>
                  <p className="fs-5 mb-4">
                    ...
                    <strong> Getty</strong> e <strong>Klever</strong> (Crypto & NFT Market), onde pude 
                  ...
                  <p className="fs-5">
                    ...
                    em <strong>mobile</strong>, <strong>UI/UX</strong> e <strong>gamificação</strong>. 
